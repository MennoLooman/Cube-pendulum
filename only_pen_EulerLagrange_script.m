...
syms th1 th1d th1dd real1 %states
syms m_p r_p I_p g real1 damp_pendulum %parameters
q   = [th1     ]';
qd  = [th1d    ]';
qdd = [th1dd   ]';
...
function res = dt(input)
    ...
    res = diff(input,th1)*th1d + diff(input,th1d)*th1dd;
end
