...
damp_motor_val = 0.10; %random guess
% 
% %function for evaluating:
MNQF = matlabFunction(subs(MNQF_para,{m_p r_p r_m I_m g motor_constant damp_motor voltage damp_pendulum s_m}, {m_p_val r_p_val r_m_val I_m_val g_val motor_constant_val damp_motor_val 0 0 0} )); 
%MNQF = matlabFunction(MNQF_para); 
