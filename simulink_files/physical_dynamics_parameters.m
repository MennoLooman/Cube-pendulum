...
%% parameters
gval = 9.81;            % gravity
I_m_val = 1.0*10^-3;    % motor inertia
r_m = 0.085;            % motor to pendulum radius
r_p = 0.129/2;          % center of gravity of pendulum to axle
m_p = 0.024;            % mass of pendulum
 
damp_motor = 0.10;      % dampening in motor
